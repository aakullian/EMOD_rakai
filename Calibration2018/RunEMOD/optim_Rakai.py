...
from site_Rakai import RakaiCalibSite
...
sites = [ RakaiCalibSite( # note that the internal site structure is a bit different from previous calibration sites
            analyzers=analyzers,
